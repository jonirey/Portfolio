...
/*=================================mixitup mixer porftolio====================*/
/*===============Sacado de https://www.kunkalabs.com/mixitup/================== */
...
const swiper = new Swiper('.testimonial__container', {
  ...
  gsap.from('.home__social', {opacity: 0, duration:2, delay:2.3, y:25, ease:'expo.out', stagger:.2 } ) 
  /*gsap.from('.nav__item', {opacity: 0, duration:2, delay:1.8, y:25, ease:'expo.out', stagger:.2 } ) */
